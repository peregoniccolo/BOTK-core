...
{
	// dataproviders with now declarations 
	#[DataProvider('tokens')]
	...
	#[DataProvider(methodName: 'emails')]
	...
	#[DataProvider(methodName: 'turtle_strings')]
	...
	#[DataProvider(methodName: 'httpUrls')]
	...
	#[DataProvider(methodName: 'httpUris')]
	...
	#[DataProvider(methodName: 'GGMMYYYYdates')]
	...
	#[DataProvider(methodName: 'MMGGYYYYdates')]
	...
	#[DataProvider(methodName: 'booleans')]
	public function testBooleans($data, $expectedData)
	{
